...
struct FFmpegPlayerCtx {
    ...
    std::mutex       *pictq_mutex = nullptr;
    std::condition_variable       *pictq_cond = nullptr;
    ...
    void init()
    {
        ...
        pictq_mutex = new std::mutex();
        pictq_cond  = new std::condition_variable();
    }
